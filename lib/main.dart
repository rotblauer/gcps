...
final ThemeData MyTheme = ThemeData(
    ...
    canvasColor:
        Colors.black, //Color.fromRGBO(18, 18, 36, 1), // Colors.blueGrey[900],
...
// [GyroscopeEvent (x: 0.0, y: 0.0, z: 0.0)]
  ...
  void _handleStreamLocationUpdate(bg.Location location) async {
    ...
    setState(() {
      ...
      _tripDistance =
          _distanceTracker.distance != null && !_distanceTracker.distance.isNaN
              ? _distanceTracker.distance
              : 0.0;
        ...
        Column(
          ...
          children: [
            ...
            InfoDisplay2(
              ...
              options: {
                't2.font': TextStyle(
                    color: Colors.white, fontSize: 96, fontFamily: 'monospace'),
                'third': Text(glocation.coords.speedAccuracy != null
                    ? glocation.coords.speedAccuracy.toString()
                    : '')
              },
          ...
          children: [
            ...
            Container(
              ...
              child: InfoDisplay2(
                ...
                // value: '5h 47m',
                value:
                    '${DateTime.now().difference(_tripStarted).inHours.toString().padLeft(2, "0")}:${(DateTime.now().difference(_tripStarted).inMinutes % 60).toString().padLeft(2, "0")}m',
